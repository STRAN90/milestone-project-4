"""
Django settings for cookbooknook project.
...
STATIC_URL = 'https://cookbooknook1.s3.amazonaws.com/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static'), ]
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

MEDIA_URL = 'https://cookbooknook1.s3.amazonaws.com/media/'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'cookbooknook1'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'cookbooknook@example.com'
else:
